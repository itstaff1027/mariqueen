...
class FinanceMTOOrdersController extends Controller
{
    public function index(Request $request){
        ...
        return inertia('Finance/MTOOrders/Page', [
    ...
    public function show(string $id){
        ...
        return inertia('Finance/MTOOrders/View/Page', [
    ...
    public function update_status(Request $request, string $id){
        ...
        return redirect()->route('finance_mto_orders.index')->with('success', 'Status updated successfully');
    }
}
