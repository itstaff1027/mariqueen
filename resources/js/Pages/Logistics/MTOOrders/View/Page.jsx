...
const LogisticsMTOOrderEdit = ({ made_to_order }) => {
    ...
    const updateStatus = (status) => {
        if (
            ...
            router.post(`/logistics_mto_orders/update/status/${made_to_order.id}`, { new_status: newStatus})
...
export default LogisticsMTOOrderEdit;
