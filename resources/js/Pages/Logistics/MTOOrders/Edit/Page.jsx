...
const MTOOrderEdit = ({ made_to_order }) => {
    const { data, setData, put, errors } = useForm({
        tracking_number: made_to_order.tracking_number || '',
        alteredItems: made_to_order.items || [],
    });
    const [items, setItems] = useState(data.alteredItems);
    // const 

    const handleUpdate = (e) => {
        e.preventDefault();
        put(`/logistics_mto_orders/${made_to_order.id}`);
    };

    const handleQuantityChange = (item_id, field, value) => {
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden">
                    <div className="p-8 space-y-6">
                                        ...
                                        <tr key={item.id} className="hover:bg-gray-50 transition">
                                            ...
                                            <td className="border px-4 py-2 text-center">
                                                <TextInput 
                                                    ...
                                                    name="quantity"
                                                    value={item.quantity}
                                                    onChange={(e) => handleQuantityChange(item.id, 'quantity', e.target.value)}
                                            ...
                                            <td className="border px-4 py-2 text-center">
                                                <TextInput 
                                                    ...
                                                    onChange={(e) => handleQuantityChange(item.id, 'unit_price', e.target.value)}
                                                    className="w-full border px-4 py-2"
                                                    disabled
                                                />
                                            </td>
                        ...
                        <div className="border-t pt-4">
                            ...
                            <Textarea
                                className="w-full border-none rounded-xl p-4 focus:outline-none focus:ring-2 focus:ring-blue-400"
                                value={data.remarks}
                                disabled
                        ...
                        <div className="border-t py-4 w-full ">
                            <InputLabel for="tracking_number" value="Tracking Number : (You can use Barcode scanner much accurate and faster encoding)" />
