...
const FinanceSalesMTOList = ({ made_to_orders }) => {
    const [printModalData, setPrintModalData] = useState(null);
    const [search, setSearch] = useState("");
    const [fromDate, setFromDate] = useState("");
    const [toDate, setToDate] = useState("");
    const handleFilter = () => {
        router.visit('/finance_mto_orders', {
            method: 'get',
                                    ...
                                    <tbody>
                                        ...
                                        <tr key={made_to_order.id}>
                                            ...
                                            <td className="border border-gray-300 px-6 py-3 space-x-2">
                                                ...
                                                {/* <Link
                                                    href={`/finance_mto_orders/${made_to_order.id}/edit`}
                                                    className="text-blue-500 hover:underline"
                                                >
                                                    Edit
                                                </Link> */}
                                                <Link
                                                    href={`/finance_mto_orders/${made_to_order.id}`}
...
export default FinanceSalesMTOList;
