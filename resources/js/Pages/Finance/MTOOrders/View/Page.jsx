...
const FinanceMTOOrderEdit = ({ made_to_order }) => {
    ...
    const allowedStatuses = (user) => {
        ...
        if (allPermissions.some(perm => perm.name === 'refund' && made_to_order.status !== 'cancelled')) {
    ...
    const updateStatus = (status) => {
        if (
            ...
            router.post(`/finance_mto_orders/update/status/${made_to_order.id}`, { new_status: newStatus})
...
export default FinanceMTOOrderEdit;
